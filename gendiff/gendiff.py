from gendiff.reader import get_data, get_file_format
...
def generate_diff(file1_path, file2_path, formatter='stylish'):
    ...
    data1, file1_format = get_data(file1_path), get_file_format(file1_path)
    data2, file2_format = get_data(file2_path), get_file_format(file2_path)
